...
To learn more about mapping sets, including how to use the fields within a mapping set, please read the [mapping set guide](./mapping-set.md). To learn how to create a mapping set and use other mapping-set-related API calls, please read the mapping set section in the [developer guide](./api/mapping-set.md).
