...
>[!TIP]
>
>Currently, date function in batch ingest removes the milliseconds if the date value are in this format: `2024-05-05 20:39:00.005` PST. If you need to preserve the milliseconds, use this format: `2024-05-05 20:39:00.005-0800`
