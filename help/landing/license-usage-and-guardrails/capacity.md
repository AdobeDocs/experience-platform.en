...
If your usage goes to above 100% of your licensed capacity, you will be considered in breach of your capacity. If you're in breach of your capacity, the following limitations will be applied:

>[!NOTE]
>
>If you have access to Adobe Journey Optimizer, the following limitations will **not** apply.

- Event data **can** be removed from streaming segmentation if the event processing queue exceeds 12 hours
- Removed event data will **not** be ingested into Profile
  - You will be able to see which events were removed
  - Events will temporarily be available within the data lake, according to your entitlements
