...
| [[!DNL Flow Service] API guide](../sources/home.md) <br> (Sources & Destinations) | The [!DNL Flow Service] API is used to collect and centralize your data from various disparate sources and is used to create and activate data to various destinations within Adobe Experience Platform. The service provides a RESTful API from which all supported sources are connectable. |
