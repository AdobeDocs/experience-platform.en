...
|403 | Forbidden | <p>The resource was found, but you do not have the right credentials to view it.</p><p> A likely cause of this error is that you might not have the required [access control permissions](/help/access-control/home.md) to access or edit the resource. Read how to [get the necessary attribute-based access control permissions](/help/landing/api-authentication.md#get-abac-permissions) to use Platform APIs. </p> |
