...
All users and applications must have proper authentication and authorization to access your key vault. To enable Azure role-based access control, select **[!DNL Access configuration]** in the left navigation, then select **[!DNL Azure role-based access control]**.
