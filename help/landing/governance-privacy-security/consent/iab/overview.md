...
In order for the SDK to send data to Experience Platform, you must first create a new datastream for Platform in the Data Collection UI. Specific steps for how to create a new datastream are provided in the [SDK documentation](../../../../edge/datastreams/overview.md).
