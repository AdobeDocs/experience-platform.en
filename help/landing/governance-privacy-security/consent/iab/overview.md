...
description: Learn how to configure your data operations and schemas to convey user consent choices when activating segments to destinations in Adobe Experience Platform.
---
