...
This document provides an overview of how to configure your Platform data operations to collect customer consent data generated by your consent-management platform (CMP), and integrate that data into customer profiles for downstream use cases.
