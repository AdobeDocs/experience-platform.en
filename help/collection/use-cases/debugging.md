...
When debugging is enabled, the Web SDK outputs messages to the browser console that can be helpful in debugging your implementation. It also enables the ability to see [`_satellite.logger`](../tags/logger.md) messages if you use tags as your implementation method. Debugging is valuable when you want to understand how the SDK behaves according to the rules and data elements that you have established.
