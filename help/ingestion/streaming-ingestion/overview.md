...
| --------- | ---------------- |
| Real-Time Customer Profile | <ul><li>< 15 minutes at the 95th percentile for B2C Data Ingestion.</li><li>< 30 minutes at the 95th percentile for B2B Data Ingestion.</li> |
