...
| Upsert batch ingestion | Ingestion of upsert batches in a given day can be up to 10x slower than regular batches. You are recommended to **keep your upsert batches under two million records** in order to ensure an efficient runtime and to not block other batches from being processed in the sandbox. | While you can certainly ingest batches that exceed two million records, the duration of your ingestion will be much longer, as you will be beholden to the constraints of small sandboxes. |
