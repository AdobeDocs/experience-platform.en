...
| Encrypted data ingestion | The maximum supported size of a single encrypted file is 1 GB. For example, you can ingest 2 GBs worth of data in a single dataflow run. However, any individual file in that data cannot exceed 1 GB. | Read the [encrypted data ingestion API guide](../sources/tutorials/api/encrypt-data.md) for more information. |
