...
| [!DNL Destinations] | [!UICONTROL Manage and Activate Datasets without Mapping] | Ability to read, create, edit, and disable dataset export flows. Ability to also activate data to active datasets that have been created. |
