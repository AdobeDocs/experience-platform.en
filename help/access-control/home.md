...
| [!DNL Destinations] | [!UICONTROL Activate Destinations] | Ability to activate data to active destinations that have been created. This permission requires either [!UICONTROL View Destinations] or [!UICONTROL Manage Destinations] to be granted to the user who will activate destinations. |
| [!DNL Destinations] | [!UICONTROL Activate Destinations Without Mapping] | Ability to activate data to active destinations that have been created, without having to go through the mapping step. This permission requires either [!UICONTROL View Destinations] or [!UICONTROL Manage Destinations] to be granted to the user who will activate destinations. WHen this permission is active, the mapping step is not displayed in the workflow. |
