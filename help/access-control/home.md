...
| [!DNL Destinations] | [!UICONTROL Activate Destinations] | Gives users the ability to activate segments to existing destinations. Enables the mapping step in the activation workflow. This permission requires either [!UICONTROL View Destinations] or [!UICONTROL Manage Destinations] to be granted to the user who will activate data to destinations. This permission and the [!UICONTROL Activate Destinations Without Mapping] permission are mutually exclusive.|
| [!DNL Destinations] | [!UICONTROL Activate Destinations Without Mapping] | Gives users the ability to activate segments to existing destinations, without displaying the mapping step. This permission requires either [!UICONTROL View Destinations] or [!UICONTROL Manage Destinations] to be granted to the user who will activate data to destinations. This permission and the [!UICONTROL Activate Destinations] permission are mutually exclusive. |
