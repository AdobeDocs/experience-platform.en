...
| [!UICONTROL Network Lookup] | Enables network lookups for the selected options, based on the visitor IP address. Available options: <ul><li>Carrier</li><li>Domain</li><li>ISP</li></ul>Use these options to provide more information to other services about the specific network where the requests originated.|
