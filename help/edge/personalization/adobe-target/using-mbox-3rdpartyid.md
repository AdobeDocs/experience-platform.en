...
1. Configure the `Target Third Party ID Namespace` in your [Datastream](../../fundamentals/datastreams.md), using the ID Namespace you would like to use as an mbox 3rd party ID. 
[Learn more about ID namespaces](https://experienceleague.adobe.com/docs/experience-platform/identity/namespaces.html)

  ![](assets/mbox3rdpartyid.png)

2. Send the `mbox3rdpartyId` to Target in the `sendEvent` command, using the ID namespace that you have configured in Step 1.
