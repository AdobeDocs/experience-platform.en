...
This guide leads you through the different ways to set up the Adobe Experience Platform Web SDK in Launch. To use this feature you need to be on the allow list. If you would like to get on the waiting list please reach out to your Certified software manager (CSM).
