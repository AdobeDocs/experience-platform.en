...
>[!NOTE]
>
>The NPM package relies on CommonJS modules; therefore, when using a bundler, you will need to make sure the bundler supports CommonJS modules. Some bundlers such as [Rollup](https://rollupjs.org) require a [plugin](https://www.npmjs.com/package/@rollup/plugin-commonjs) that provides CommonJS support.
