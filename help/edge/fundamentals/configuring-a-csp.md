...
### Use NONCE to allow for inline script and style elements
...
In addition the CSP nonce needs to be added as an attribute to the [!DNL Platform Web SDK] [base code](installing-the-sdk.md#adding-the-code) script tag. That way [!DNL Platform Web SDK] will use that nonce when adding additional inline script or style tags to the page:

```
<script nonce="SERVER-GENERATED-NONCE">BASE-CODE</script>
```
