...
![Image showing the [!UICONTROL Data Cleansing] workspace in the Platform UI](../images/ui/browse/work-order-list.png)
...
![Image showing the details page for a customer delete work order](../images/ui/browse/customer-delete-details.png)
