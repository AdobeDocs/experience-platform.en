...
description: The Sandbox tooling API allows developers to examine artifacts and export and import a snapshot of sandbox configurations between sandboxes.  Follow this guide to learn how to perform key operations using the API.
---
