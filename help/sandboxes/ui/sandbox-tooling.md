...
| [!DNL Adobe Journey Optimizer] | Campaigns |  Campaign objects can be copied from one sandbox to another. For a complete list of objects that can be copied, as well as any restrictions, read the [exporting objects to another sandbox guide](https://experienceleague.adobe.com/en/docs/journey-optimizer/using/configuration/copy-objects-to-sandbox). |
