...
| [!UICONTROL Third Party ID Sync Container ID] | The numeric ID of the container to be used for third party ID sync.<br><br>**Note:** The datastream references the default Audience Manager Container ID, which is 0. If you have multiple Audience Manager ID sync Container IDs, please work with your Audience Manager consultant to properly identify and resolve the ID sync configuration. |
