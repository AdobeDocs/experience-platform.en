...
If you enable any of these fields for collection, make sure that the [`context`](../edge/data-collection/automatic-information.md) array property is correctly set when [configuring the Web SDK](../edge/fundamentals/configuring-the-sdk.md). Geolocation lookup fields use the `context` array string `"placeContext"`, while network lookup fields use the `context` array string `"environment"`.
...
If you enable any of these fields for collection, make sure that the [`context`](../edge/data-collection/automatic-information.md) array property is correctly set when [configuring the Web SDK](../edge/fundamentals/configuring-the-sdk.md). Device and hardware information use the `context` array string `"device"`, while browser and operating system information use the `context` array string `"environment"`. 
