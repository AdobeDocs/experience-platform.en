...
* Ask an AI assistant connected through [Adobe CX Coworker Gateway](https://experienceleague.adobe.com/en/docs/cx-enterprise-ai/experience-cloud-ai/mcp/overview){target="_blank"} to summarize your latest health check assessment results. See [Experience Platform tools in Adobe CX Coworker Gateway](https://experienceleague.adobe.com/en/docs/cx-enterprise-ai/experience-cloud-ai/mcp/mcp-product-tools/aep-mcp){target="_blank"}.
