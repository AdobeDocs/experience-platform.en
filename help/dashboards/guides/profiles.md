...
![The Customer profile widget.](../images/profiles/customer-profile.pmg)
...
![The Linked identities widget.](../images/profiles/linked-identities.pmg)
...
<!-- See the documentation on consent preferences for more information: -->

>[!TIP]
>
>To learn how to process customer consent and preference data using the Adobe standard, see the overview on [consent processing in Experience Platform.](https://experienceleague.adobe.com/docs/experience-platform/landing/governance-privacy-security/consent/adobe/overview.html). 

<!-- The consent processing document details the data operations to ingest customer consent data generated by a consent-management platform (CMP) and integrate that data into customer profiles. -->
...
To learn how to build a consent policy that filters profiles for segmentation based on their consent preferences, see the [user guide](https://experienceleague.adobe.com/docs/experience-platform/data-governance/policies/user-guide.html?lang=en#combine-policies) on managing data usage policies. 

<!--See the managing data usage policies guide to learn how to use Platform to adopt and enforce marketing policies that respect the consent preferences of your customers. -->
...
![The Profiles Detail workspace with [!UICONTROL Customize profile details] highlighted.]()
