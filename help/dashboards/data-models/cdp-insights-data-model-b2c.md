...
| `count_of_calculated_exited_profiles` | The number of profiles that exited the segment yesterday. |
...
### Overlap Namespace by audience model {#overlap-namespace-by-audience-model} 
