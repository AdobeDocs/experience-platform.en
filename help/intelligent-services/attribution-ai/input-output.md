...
| id (String) | True | Identity ID of the user such as cookie ID, Adobe Analytics ID (AAID), or Experience Cloud Visitor ID (ECID, also known as MCID) etc. <br> **Example:** 17348762725408656344688320891369597404 |
