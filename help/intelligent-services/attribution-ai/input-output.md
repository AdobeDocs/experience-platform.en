...
>[!TIP]
>
>If you are using Adobe Analytics data in your CEE schema (not using the Adobe Analytics source connector), the touchpoint information for Analytics is typically stored in `channel.typeAtSource`.
