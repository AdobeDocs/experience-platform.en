...
In order to view and export audit logs, you must have been granted the Audit Logs Access access control permission in Adobe Console. To learn how to manage individual permissions for Attribution AI features, please refer to the access control documentation [ LINK TO ACCESS CONTROL PAGE]. 
