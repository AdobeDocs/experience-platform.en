...
![Navigate to the Customer AI service in the Experience Platform UI.](../images/user-guide/navigate-to-service.png)
...
![Total profiles scored metric in Customer AI.](../images/user-guide/total-profiles.png)
...
- **[!UICONTROL Delete]**: You can delete a service instance including any historical runs. The corresponding output dataset will be deleted from Experience Platform. However, scores that were synced to Real-Time Customer Profile are not deleted.
...
![Service instance panel in Customer AI.](../images/user-guide/service-instance-panel.png)

To create a new instance, select **[!UICONTROL Create instance]**.

![Customer AI dashboard showing an overview of service instances and their statuses.](../images/user-guide/dashboard.png)
...
![Setup screen showing the instance creation workflow in Customer AI.](../images/user-guide/create-instance.png)
...
![Dataset selection screen showing the search bar and save options highlighted.](../images/user-guide/configure-dataset-page-save-and-exit-cai.png)
...
![Dataset selection screen showing selected datasets in the preview pane.](../images/user-guide/select-datasets.png)

Selecting the info icon ![info icon](/help/images/icons/info.png) next to the dataset opens the dataset preview popover.

![Dataset selection screen showing the search bar and dataset information.](../images/user-guide/dataset-info.png)
...
![Dataset completeness showing a dataset preview with completeness percentage highlighted.](../images/user-guide/dataset-info-2.png)
...
![Identity map selection screen showing the same namespace being selected for multiple datasets.](../images/user-guide/cai-identity-map.png)
...
![Identity map selection screen showing the same namespace being selected for multiple datasets.](../images/user-guide/cai-identity-namespace.png)
...
![An example showing a dataset key not selected in the identity map selection screen.](../images/user-guide/select-identity.png)
...
![Define goal step in Customer AI showing the interactive environment for defining a prediction goal.](../images/user-guide/cai-define-a-goal.png)
...
![An example showing the configuration of a goal where an event will occur.](../images/user-guide/cai-will-occur.png)
...
![An example showing the configuration of a goal where an event will not occur.](../images/user-guide/not-occur.png)
...
![An example showing the configuration of a goal where all conditions must be met.](../images/user-guide/all-of.png)
...
![An example showing the configuration of a goal where any condition can be met.](../images/user-guide/any-of.png)
...
![An example showing the configuration of an eligible population in Customer AI.](../images/user-guide/eligible-population.png)
...
![An example showing the configuration of an event feature in Customer AI.](../images/user-guide/event-feature.png)
...
![An example showing the configuration of a custom event field in Customer AI.](../images/user-guide/custom-event.png)
...
![An example showing the available operators for configuring a custom event in Customer AI.](../images/user-guide/custom-operator.png)
...
![An example showing the configuration of a custom event field value in Customer AI.](../images/user-guide/custom-value.png)
...
![An example showing the configuration of a custom profile attribute in Customer AI.](../images/user-guide/profile-attributes.png)
...
![An example showing the configuration of a custom event with a user-defined name in Customer AI.](../images/user-guide/custom-event-name.png)
...
![An example showing the scoring schedule configuration options in Customer AI.](../images/user-guide/schedule.png)
...
![An example showing the configuration of prediction exclusions in Customer AI.](../images/user-guide/exclusion.png)
...
![An example showing the Profile toggle option in the Customer AI advanced workflow.](../images/user-guide/advanced-workflow-save.png)
...
By following this tutorial, you have successfully configured an instance of Customer AI and generated propensity scores. You can now choose to use Audience Builder to [create audiences with predicted scores](./create-segment.md) or [discover insights with Customer AI](./discover-insights.md).
