...
- [Audience Builder user guide](../../segmentation/tutorials/create-a-segment.md): Experience Platform allows you to easily create and access segments, as well as use different building blocks to further characterize your segments.
