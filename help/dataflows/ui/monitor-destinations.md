...
>abstract="The destination dataflow run details contain information on the segment's activation status and metrics taken from Real-Time Customer Profile to generate unique identities. To learn more, review the metric definitions guide."
...
![Segments highlighted in the dataflow panel.](../assets/ui/monitor-destinations/dashboard-segments-view.png)
...
![Radio buttons showing how to filter dataflow runs for segments.](/help/dataflows/assets/ui/monitor-destinations/dataflow-runs-segment-filter.png)
...
![Segments view in the dataflow run details screen.](../assets/ui/monitor-destinations/dataflow-run-segments-view.png)
