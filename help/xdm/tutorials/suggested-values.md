...
>[!NOTE]
>
>The optional JSON Schema `default` property documents an intended value in the schema definition. Experience Platform does not automatically apply `default` during ingestion or Data Prep. See [type-specific field properties in the UI](../ui/fields/overview.md#type-specific-properties).
