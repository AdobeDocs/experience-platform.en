...
## Define a new field group {#define-mixin}

The "[!UICONTROL Loyalty Members]" schema is meant to capture data related to the members of a loyalty program, so it will require some specific loyalty-related fields. There are no standard field groups available that contain the necessary fields, therefore you will need to define a new field group.

This time, when you open the **[!UICONTROL Add Mixin]** dialog, select **[!UICONTROL Create New Mixin]**. You will then be asked to provide a display name and description for your field group. 
