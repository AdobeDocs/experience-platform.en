...
The [!UICONTROL Schemas] workspace in the [!DNL Experience Platform] UI provides a visualization of the [!DNL Schema Library], allowing you to view and manage the schemas available for your organization. The workspace also includes the [!DNL Schema Editor], the canvas on which you can compose a schema throughout this tutorial.
