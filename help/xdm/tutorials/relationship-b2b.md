...
The [!UICONTROL Add relationship] dialog appears. Use this dialog to specify details about the relationship. The relationship type is automatically set to **[!UICONTROL Many-to-one]**.
