...
In Experience Data Model (XDM), you can deprecate a field within a schema or custom resource by using the [Schema Registry API](https://developer.adobe.com/experience-platform-apis/references/schema-registry/). This document covers how to deprecate fields for different XDM resources.
