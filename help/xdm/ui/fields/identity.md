...
Since all identity fields are required by default, the field is now listed under **[!UICONTROL Required fields]** in the left navigation. If the identity field is nested within the schema structure, all parent fields will also be listed as required.
