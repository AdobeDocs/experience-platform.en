...
- **[Standard schemas](#standard-based-creation)**: Perfect for event and profile data using Adobe's predefined classes and field groups.
...
### Create a standard schema {#standard-based-creation}
