...
To browse field groups in the Schema Library and understand schema usage, filtering, and metadata that affect schema design and data ingestion, see [Explore schema resources in the UI](../explore.md).
