...
description: The /fieldgroups endpoint in the Schema Registry API allows you to programmatically manage XDM field groups within your experience application.
