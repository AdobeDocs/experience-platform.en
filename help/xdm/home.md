...
Although you are able to define your own classes within the [!DNL Schema Registry], it is recommended that you use the preferred classes **[!UICONTROL XDM Individual Profile]** and **[!UICONTROL XDM ExperienceEvent]** for record and time-series data, respectively. These classes are outlined in more detail below.
