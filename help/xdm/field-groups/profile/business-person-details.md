...
---
# [!UICONTROL XDM Business Person Details] schema field group (Beta)

>[!IMPORTANT]
>
>This field group is available as part of Real-time Customer Data Platform B2B Edition, which is currently in beta. The documentation and functionality are subject to change.å
