...
* Schemas {#schema}
  ...
  * Healthcare Data Model V2 {#healthcare}
    * {hide-from-toc} [Healthcare V2](./schema/healthcare/healthcare-v2.md)
    * Classes {#classes}
      * {hide-from-toc} [Location](./schema/healthcare/classes/location.md)
    * Field groups {#field-groups}
      * {hide-from-toc} [Account](./schema/healthcare/field-groups/account.md)
      * {hide-from-toc} [Appointment](./schema/healthcare/field-groups/appointment.md)
      * {hide-from-toc} [Care Plan](./schema/healthcare/field-groups/care-plan.md)
      * {hide-from-toc} [Coverage](./schema/healthcare/field-groups/coverage.md)
      * {hide-from-toc} [Goal](./schema/healthcare/field-groups/goal.md)
      * {hide-from-toc} [Immunization](./schema/healthcare/field-groups/immunization.md)
      * {hide-from-toc} [Location](./schema/healthcare/field-groups/location.md)
      * {hide-from-toc} [Medication](./schema/healthcare/field-groups/medication.md)
      * {hide-from-toc} [Medication Dispense](./schema/healthcare/field-groups/medication-dispense.md)
      * {hide-from-toc} [Medication Request](./schema/healthcare/field-groups/medication-request.md)
      * {hide-from-toc} [Organization](./schema/healthcare/field-groups/organization.md)
      * {hide-from-toc} [Patient](./schema/healthcare/field-groups/patient.md)
      * {hide-from-toc} [Practitioner](./schema/healthcare/field-groups/practioner.md)
      * {hide-from-toc} [Schedule](./schema/healthcare/field-groups/schedule.md) 
    * Data Types {#data-types}
      * {hide-from-toc} [Address](./schema/healthcare/data-types/address.md)
      * {hide-from-toc} [Annotation](./schema/healthcare/data-types/annotation.md)
      * {hide-from-toc} [Availability](./schema/healthcare/data-types/availability.md)
      * {hide-from-toc} [Codeable Concept](./schema/healthcare/data-types/codeable-concept.md)
      * {hide-from-toc} [Codeable Reference](./schema/healthcare/data-types/codeable-reference.md)
      * {hide-from-toc} [Coding](./schema/healthcare/data-types/coding.md)
      * {hide-from-toc} [Contact Point](./schema/healthcare/data-types/contact-point.md)
      * {hide-from-toc} [Dosage](./schema/healthcare/data-types/dosage.md)
      * {hide-from-toc} [Duration](./schema/healthcare/data-types/duration.md)
      * {hide-from-toc} [Extended Contact Details](./schema/healthcare/data-types/extended-contact-detail.md)
      * {hide-from-toc} [Human Name](./schema/healthcare/data-types/human-name.md)
      * {hide-from-toc} [Identifier](./schema/healthcare/data-types/identifier.md)
      * {hide-from-toc} [Money](./schema/healthcare/data-types/money.md)
      * {hide-from-toc} [Period](./schema/healthcare/data-types/period.md)
      * {hide-from-toc} [Person](./schema/healthcare/data-types/person.md)
      * {hide-from-toc} [Quantity](./schema/healthcare/data-types/quantity.md)
      * {hide-from-toc} [Range](./schema/healthcare/data-types/range.md)
      * {hide-from-toc} [Ratio](./schema/healthcare/data-types/ratio.md)
      * {hide-from-toc} [Reference](./schema/healthcare/data-types/reference.md)
      * {hide-from-toc} [Repeat](./schema/healthcare/data-types/repeat.md)
      * {hide-from-toc} [Simple Quantity](./schema/healthcare/data-types/simple-quantity.md)
      * {hide-from-toc} [Timing](./schema/healthcare/data-types/timing.md)
      * {hide-from-toc} [Virtual Service](./schema/healthcare/data-types/virtual-service-detail.md)
