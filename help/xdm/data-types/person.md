...
![person image](../images/data-types/person.PNG){width=500}

| Property | Data type | Description |
| --- | --- | --- |
| `name` | [[!UICONTROL Person name]](./person-name.md) | Describes details about the person's full name. |
| `birthDate` | Date | The full date a person was born. The date format (without time) should follow the [ISO 8601](https://datatracker.ietf.org/doc/html/rfc3339#section-5.6) standard (`yyyy-MM-dd`). |
