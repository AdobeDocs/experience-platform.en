...
| `mediaEventTimestamp` | [!UICONTROL String] | The time when a media event occurred, in [ISO 8601](https://datatracker.ietf.org/doc/html/rfc3339#section-5.6) format (`yyyy-MM-dd'T'HH:mm:ssXXX`). |
