...
>abstract="Enable this toggle to allow the selected dataset to be used in Adobe Journey Optimizer Orchestrated Campaigns. The dataset must use a model-based schema and only one dataset can be created per schema."
