...
description: Learn about Adobe Experience Platform Segmentation Service and the role it plays in the Experience Platform ecosystem.
exl-id: 2c18a806-88ed-4659-bdfd-2377f5a09a1a
TQID: https://experienceleague.adobe.com/WbIsL4g5VqVzslpxrPgc0X7fB7VvMeGWWyGJL4UxUx8
product_v2:
...
>abstract="Edge segmentation is the ability to evaluate segments in Experience Platform instantaneously on the Edge Network, enabling same-page and next-page personalization use cases."
...
Edge segmentation is the ability to evaluate segments in Experience Platform instantaneously [on the Edge Network](../landing/edge-and-hub-comparison.md), enabling same-page and next-page personalization use cases. 

To learn more about edge segmentation, please read the [edge segmentation overview](./methods/edge-segmentation.md).
...
If a merge policy is not defined, the default [!DNL Experience Platform] merge policy is used. If you would rather use a merge policy specific to your organization, you can create your own and mark it as your organization's default.
