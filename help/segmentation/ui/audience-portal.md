...
For externally generated audiences, the **[!UICONTROL Ingestion details]** section shows both the profile total, as well as details of the dataset the externally generated audience was ingested into.
...
| Profile batch | The ID of the batch that ingested the data into Platform. You can select the ID of the batch for more information about the batch. To learn more about batches, read the [monitoring data ingestion guide](../../ingestion/quality/monitor-data-ingestion.md#viewing-batches). |
