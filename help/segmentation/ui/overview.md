...
The churn represents the percentage of profiles that are (revolving?), while the profile count represents the total number of profiles that qualify for the segment.
