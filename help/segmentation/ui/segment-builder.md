...
If selecting a value from this list of enums, the value will be outlined with a solid border. However, you can select a value which is **not** from the list of enums. If you create your own value, this value will be outlined with a dotted border, along with a warning that this value is not in the enum list.
