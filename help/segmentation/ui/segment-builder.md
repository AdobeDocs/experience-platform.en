...
>[!CONTEXTUALHELP]
>id="platform_segments_createsegment_segmentbuilder_sampleprofiles"
...
This number is updated when the sample job is updated, which occurs when there is a greater than 5% change in customer data or the last sample job is older than 7 days."
