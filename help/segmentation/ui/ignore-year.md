...
If you created an audience before this fix was released, you just need to re-save the audience in Audience Builder in order to apply the fix. If you're unsure if your audience is affected by this resolution, Audience Builder will prompt the user if the existing audience is affected by this issue.
