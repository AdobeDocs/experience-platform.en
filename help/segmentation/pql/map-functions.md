...
The `get` function is used to retrieve the value of a map for a given key. This function returns an object.
...
The `keys` function is used to retrieve all the keys for a given map. This function returns an array or list.
...
The `values` function is used to retrieve all the values of a given map. This function returns an array or list.
