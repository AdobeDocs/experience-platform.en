...
The `isNull` function determines if an object reference does not exist. This function returns a boolean.
...
The `isNotNull` function determines if an object reference exists. This function returns a boolean.
