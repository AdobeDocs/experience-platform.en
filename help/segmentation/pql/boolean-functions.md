...
The `and` function is used to create a logical conjunction. This function returns a boolean.
...
The `or` function is used to create a logical disjunction. This function returns a boolean.
...
The `if` function is used to resolve an expression depending on whether a specified condition is true. This function returns a boolean.
