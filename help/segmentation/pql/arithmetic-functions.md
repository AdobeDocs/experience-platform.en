...
The `+` (addition) function is used to find the sum of two argument expressions. This function returns a number.
...
The `*` (multiplication) function is used to find the product of two argument expressions. This function returns a number.
...
The `-` (subtraction) function is used to find the difference of two argument expressions. This function returns a number.
...
The `/` (division) function is used to find the quotient of two argument expressions. This function returns a number.
...
The `%` (modulo/remainder) function is used to find the remainder after dividing the two argument expressions. This function returns a number.
