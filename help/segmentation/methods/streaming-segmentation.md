...
- The segment definition matches the following rulesets:
  - A single event with a time window longer than 24 hours
    - For example, "Activate an audience with all profiles that viewed a webpage in last 3 days".
  - A single event with no time window
    - For example, "Activate an audience with all profiles that viewed a webpage".
