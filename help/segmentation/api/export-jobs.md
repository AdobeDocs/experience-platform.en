...
After reading this guide you now have a better understanding of how export jobs work. For more information on other Segmentation API endpoints, please read the [Segmentation developer guide](./getting-started.md). 