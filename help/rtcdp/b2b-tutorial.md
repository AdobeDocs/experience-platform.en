...
>[!NOTE]
> 
>For instructions on how to create audiences to evaluate your data see the [Audience Builder UI guide](../segmentation/ui/audience-builder.md). For more specific B2B segmentation use cases, refer to the [segmentation overview for Real-Time CDP B2B Edition](./segmentation/b2b.md).
