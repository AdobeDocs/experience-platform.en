...
For an account profile overview, begin by selecting **[!UICONTROL Profiles]** under [!UICONTROL Accounts] in the left-navigation. On the  **[!UICONTROL Overview]** tab, you see a high-level visibility into the account/ opportunities dashboards from a single entry point.
