...
>[!IMPORTANT] If the ID of your CMP is invalid, Real-time CDP will keep processing your data as-is. In order to enforce TCF 2.0, you must confirm that your CMP has a valid ID that has been registered with IAB TCF 2.0 before sending data to [!DNL Experience Platform].
