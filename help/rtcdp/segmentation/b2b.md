...
>[!IMPORTANT]
>
>Audiences that contains Experience Events that reference B2B entities (such as Campaigns and Marketing Lists) are no longer supported. For more information, read the guide on [Real-Time CDP B2B Edition architecture upgrades](../../rtcdp/b2b-architecture-upgrade.md).
