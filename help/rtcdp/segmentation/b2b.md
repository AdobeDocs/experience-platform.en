...
>[!IMPORTANT]
>
>Audiences that include Experience Events referencing B2B entities (such as Campaigns and Marketing Lists) are no longer supported. For details, read the [Real-Time CDP B2B Edition architecture upgrades guide](../../rtcdp/b2b-architecture-upgrade.md).
