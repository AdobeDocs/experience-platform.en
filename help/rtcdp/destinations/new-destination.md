...
title: Self-service template // Replace with YOURDESTINATION.md, where YOURDESTINATION is the name of your destination
seo-title: Self-service template // Replace with YOURDESTINATION.md, where YOURDESTINATION is the name of your destination
description: Use this template to create public documentation for your destination in the Adobe Real-time CDP catalog. // Replace with the paragraph in the Overview section
seo-description: Use this template to create public documentation for your destination in the Adobe Real-time CDP catalog. // Replace with the paragraph in the Overview section
---
