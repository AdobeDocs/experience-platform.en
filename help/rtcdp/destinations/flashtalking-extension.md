...
# Flashtalking OneTag extension {#flashtalking-extension}

## Overview {#overview}

The Flashtalking OneTag extension for Experience Platform Launch makes it easy to attribute site actions to display, video, and mobile ad activity. Deploy the Flashtalking OneTag to your web properties using Launch.

Flashtalking OneTag is an advertising extension in Adobe Real-time Customer Data Platform. For more information about the extension functionality, see the extension page on [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101392.flashtalking-onetag.html).
...
![Flashtalking extension](assets/flashtalking-extension.png)
...
To install the Flashtalking OneTag extension:
