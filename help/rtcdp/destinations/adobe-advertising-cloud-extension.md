...
This is the Advertising Cloud extension for implementing Advertising Cloud conversion and segment tags for both the DSP and Search (DCO is not supported currently).
