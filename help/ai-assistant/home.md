...
| Data Models (Federated Audience Composition) | <ul><li>Data model counts</li><li>Name search</li><li>Data model and schema relationship</li><li>Link properties</li><li>Status</li><li>Creation and modification dates</li><li>Link-attribute relationships</li><li>Data model-audience relationship</li><li>Link-data model relationship</li><li>Federated Audience count</li></ul> | |
...
| Schemas (Federated Audience Composition) | <ul><li>Schema counts</li><li>Schema name/label search</li><li>Creation and modification dates</li><li>Schema-database relationship</li><li>Audience type schemas</li></ul> | |
