...
The `edgeConfigOverrides` object allows you to create dynamic datastream configurations, which you can use to define where the data should go. This override object is not a command, but rather an object that you can include in most Web SDK commands.
