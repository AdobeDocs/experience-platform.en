...
After configuring push notifications, use the [`sendPushSubscription`](../sendpushsubscription-1.md) command to register push subscriptions with Adobe Experience Platform.
