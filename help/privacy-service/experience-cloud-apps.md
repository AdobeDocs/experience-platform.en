...
Adobe Experience Platform | ✓ | ✓ | <ul><li>[Access/delete documentation](platform.md)</li><li>Experience Platform honors [opt-out requests for audience segments](https://www.adobe.io/apis/experienceplatform/home/profile-identity-segmentation/profile-identity-segmentation-services.html#!api-specification/markdown/narrative/technical_overview/segmentation/honoring-opt-outs.md).</li></ul>
