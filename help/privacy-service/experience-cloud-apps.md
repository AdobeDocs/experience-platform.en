...
| Adobe Journey Optimizer  | ✓ | N/A | The data subject's stored data is deleted from the system. | <ul><li>[Access/delete documentation](https://experienceleague.adobe.com/en/docs/journey-optimizer)</li></ul> |
