...
| Adobe Campaign Standard | ✓ | ✓ | The data subject's stored data is deleted from the system. | <ul><li>[Access/delete documentation](https://docs.campaign.adobe.com/doc/standard/getting_started/en/ACS_GDPR.html)</li><li>[Opt-out documentation](../segmentation/tutorials/consents.md)</li></ul> |
