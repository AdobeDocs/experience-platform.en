...
| `releaseNotesUrl` *(Optional)*                   | The URL to your extension's release notes, if you have a location to publish this information. This URL will be used within the Adobe Tags UI to display this link during Extension installation and upgrade. This property is only supported for Web and Edge extensions.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
