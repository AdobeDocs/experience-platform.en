...
last-substantial-update: 2025-01-20T00:00:00.000Z
exl-id: 1c2d7243-5bcd-40a0-8515-9ab72613c5f3
TQID: https://experienceleague.adobe.com/SbZbjD4PtmqMTLZfAFTB1FgNd1o90Xudfjc3EdETWvE
product_v2:
...
To use the [!DNL Snapchat] Conversions API:
...
To send data to the [!DNL Snapchat] Conversions API extension, create [data elements](https://experienceleague.adobe.com/en/docs/platform-learn/implement-web-sdk/event-forwarding/setup-event-forwarding#create-an-event-forwarding-data-element) for each data parameter. Follow these steps:
...
To use [custom conversions value and ROAS reporting](https://businesshelp.snapchat.com/s/article/custom-conversions-value-roas?language=en_US), include relevant parameters in the `contents` field. An example configuration for a purchase event could look like: `brand`, `item_price`, `id`.
