...
| --- | --- | --- |
| Ads Account Id | Your [!DNL Pinterest] Ads Account Id. Refer to the [[!DNL Pinterest]d documentation](https://developers.pinterest.com/docs/conversions/conversion-management/#Finding%20your%20%2Cad_account_id) for guidance. | 123456789012 |
