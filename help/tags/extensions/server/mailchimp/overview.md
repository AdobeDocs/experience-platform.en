...
The data required by this extension can be sent from Web SDK as either XDM data (using the [`xdm`](/help/edge/commands/sendevent/xdm.md) object) or non-XDM data (using the [`data`](/help/edge/) object).
