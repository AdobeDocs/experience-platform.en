...
| Field name | Description | Example | Required |
| --- | --- | --- | --- |
| [!UICONTROL Conversion Time] | Date-time as string in [ISO 8601](https://datatracker.ietf.org/doc/html/rfc3339#section-5.6) or in `yyyy-MM-dd'T'HH:mm:ss:SSSZ` format. | 2022-02-18T01:14:00.603Z | Yes |
