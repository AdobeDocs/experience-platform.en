...
## Integration with the Facebook & Instagram Extension. {#facebook}

The integration using the Facebook & Instagram Extension allows you to quickly authenticate into your Meta Business Account. This then auto-populates your [!UICONTROL Pixel ID] and the Meta Conversions API [!UICONTROL Access Token], making it easier to install and configure the Meta Conversions API.

A dialogue prompt to authenticate in Facebook & Instagram appears when installing the [!UICONTROL Meta Conversions API] extension.
...
A dialogue prompt to authenticate in Facebook & Instagram also appears in the quick start workflow UI within event forwarding. 
