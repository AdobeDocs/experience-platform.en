...
Because of these two points, it's worth demonstrating how the [Library Loaded](../../extensions/web/core-extension/overview.md#library-loaded-page-top), [Page Bottom](../../extensions/web/core-extension/overview.md#page-bottom), [DOM Ready](../../extensions/web/core-extension/overview.md#page-bottom), and [Window Loaded](../../extensions/web/core-extension/overview.md#window-loaded) event types from the Core extension function when loading a tag library asynchronously.
