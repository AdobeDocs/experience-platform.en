...
Event forwarding combined with the Adobe Experience Platform [Web SDK](/help/collection/js/home.md) and [Mobile SDK](https://experienceleague.adobe.com/docs/platform-learn/data-collection/mobile-sdk/overview.html) provides the following benefits:
