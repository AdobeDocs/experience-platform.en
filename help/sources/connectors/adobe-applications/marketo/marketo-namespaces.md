...
| `TECHNICAL_ACCOUNT_ID` | A credential used to integrate to [Adobe Developer Console](https://developer.adobe.com/). Follow the steps below to retrieve your technical account ID:<ul><li>Navigate to [Adobe Developer Console](https://developer.adobe.com/) and open your project.</li><li>Open the **credential** that uses _Service Account (JWT)_. **Note**: This may be referred to as "Enterprise" in older UI.</li><li>The credentials details should display your Client ID, technical account ID, Organization ID, and other JWT metadata.</li></ul>.  | `D42AEVJZTTJC6LZADUBVPA15@techacct.adobe.com` |
