...
| `m_pagename` | `web.webPageDetails.name` | string  | Equals 1 on hits that have a page name. This is similar to the Adobe Analytics Page Views metric. |
...
| `post_pagename` | `web.webPageDetails.name` | string | Equals 1 on hits that have a page name. This is similar to the Adobe Analytics Page Views metric. |
