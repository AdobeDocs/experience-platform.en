...
| mcvisid_high + mcvisid_low | endUserIDs._experience.mcid.id | string | The Experience Cloud Visitor ID (ECID) is also known as MCID and sometimes used in namespaces. |
| mcvisid_high | endUserIDs._experience.mcid.primary | boolean | The Experience Cloud Visitor ID (ECID) is also known as MCID and sometimes used in namespaces. |
| mcvisid_high | endUserIDs._experience.mcid.namespace.code | string | The Experience Cloud Visitor ID (ECID) is also known as MCID and sometimes used in namespaces. |
