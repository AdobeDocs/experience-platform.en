...
>
>- [Create a custom namespace in Identity Service](../../../identity-service/features/namespaces.md#create-custom-namespaces) with the specified identity symbol (`namespaceCode={VALUE}`) .
>- Re-ingest your data.
