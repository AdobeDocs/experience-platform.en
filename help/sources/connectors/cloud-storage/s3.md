...
Follow the steps below to learn how you can connect your [!DNL Amazon S3] bucket into Experience Platform in an AWS region.

### Prerequisites

You must have the following items to successfully configure your [!DNL Amazon S3]
