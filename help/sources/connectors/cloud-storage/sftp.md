...
The [!DNL SFTP] source supports authentication using [!DNL Base64]-encoded OpenSSH private key. See the steps below for information on how to generate your Base64-encoded OpenSSH private key to connect [!DNL SFTP] to Platform.
...
Once your [!DNL Base64]-encoded private key is saved in the folder you designated, you must then add the contents of your public key file to a new new line in the [!DNL SFTP] host authorized keys. Run the following command on the command line:

```shell
cat ~/id_rsa.pub >> ~/.ssh/authorized_keys
```

To confirm if your public key was added properly, you can run following on the command line:
