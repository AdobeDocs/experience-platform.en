...
## Connect [!DNL Azure File Storage] to [!DNL Experience Platform]

The documentation below provides information on how to connect [!DNL Azure File Storage] to [!DNL Experience Platform] using APIs or the user interface:
