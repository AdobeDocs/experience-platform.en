...
The documentation below provides information on how to connect [!DNL PayPal] to Experience Platform using APIs or the user interface:

## Connect [!DNL PayPal] to Experience Platform using APIs
...
## Connect [!DNL PayPal] to Experience Platform using the UI
