...
| Parameter | Description |
| --- | --- | 
| `webhook.address` | The http endpoint where streaming messages are sent. The template for the webhook is: `https://dcs.adobedc.net/collection/{INLET_ID}?{X_ADOBE_FLOW_ID}={FLOW_ID}.` |
