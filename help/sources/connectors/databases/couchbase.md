...
The documentation below provides information on how to connect [!DNL Couchbase] to [!DNL Experience Platform] using APIs or the user interface:

## Connect [!DNL Couchbase] to [!DNL Experience Platform] using APIs
...
## Connect [!DNL Couchbase] to [!DNL Experience Platform] using the UI
