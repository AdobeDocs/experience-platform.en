...
Experience Platform provides support for ingesting data from a third-party database. Experience Platform can connect to different types of databases such as relational, NoSQL, or data warehouses. Support for database providers include [!DNL Teradata Vantage].
...
The documentation below provides information on how to connect [!DNL Teradata Vantage] to Experience Platform using APIs or the user interface:

## Connect [!DNL Teradata Vantage] to Experience Platform using APIs
...
## Connect [!DNL Teradata Vantage] to Experience Platform using the UI
