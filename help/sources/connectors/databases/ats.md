...
TQID: https://experienceleague.adobe.com/8YO62efUNxd4kXSMmZ8IfbufmsAaxHGz1YN0wgsy9iQ
product_v2:
...
Experience Platform provides support for ingesting data from a third-party database. Experience Platform can connect to different types of databases such as relational, NoSQL, or data warehouses. Support for database providers include [!DNL Azure Table Storage].
...
The documentation below provides information on how to connect [!DNL Azure Table Storage] to Experience Platform using APIs or the user interface:

## Connect [!DNL Azure Table Storage] to Experience Platform using APIs
...
## Connect [!DNL Azure Table Storage] to Experience Platform using the UI
