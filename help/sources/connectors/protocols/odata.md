...
Experience Platform provides support for ingesting data from a third-party protocols application. Support for protocols providers include Generic OData.

The documentation below provides information on how to connect Generic OData to Platform using APIs or the user interface:

## Connect Generic OData to Platform using APIs
...
## Connect Generic OData to Platform using the UI
