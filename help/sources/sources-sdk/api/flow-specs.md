...
The following request creates a flow specification called `RestStorageToPlatform`.
...
A successful response returns the newly created flow specification, including its unique `id`.

```json
{
    "id": "9510cf45-b9a0-423d-9bdb-1e92a679b935",
    "createdAt": 1633395488637,
    "updatedAt": 1633395488637,
    "createdBy": "{CREATED_BY}",
    "updatedBy": "{UPDATED_BY}",
    "createdClient": "{CREATED_CLIENT}",
    "updatedClient": "{UPDATED_CLIENT}",
...
The following request updates the flow specification of `6499120c-0b15-42dc-936e-847ea3c24d72` to include the connection specification ID `f6c0de0c-0a42-4cd9-9139-8768bf2f1b55`.
