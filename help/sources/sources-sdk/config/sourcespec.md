...
| `sourceSpec.attributes.spec.properties.spec.properties.headerParams` | Defines the comma (`,`) separated headers that need to be supplied in the HTTP request to source URL while fetching data. | `{'user':'c26f50c88dc035610e6753f807e28e9','x-api-key':'apiKey'` |
