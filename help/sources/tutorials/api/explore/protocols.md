...
This tutorial uses the Flow Service API to explore protocols applications.
...
In order to explore your protocol system using Platform APIs, you must possess a valid base connection ID. If you do not already have a base connection for the protocol system you wish to work with, you can create one through the following tutorial:
