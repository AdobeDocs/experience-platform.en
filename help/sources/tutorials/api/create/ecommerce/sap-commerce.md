...
TQID: https://experienceleague.adobe.com/B05a7-7L-2DfqhFv6nfuTHHHSu6oaYVLGAwYgIOP5-o
product_v2:
...
## Connect [!DNL SAP Commerce] to Experience Platform using the [!DNL Flow Service] API
...
The last step towards bringing data from [!DNL SAP Commerce] to Experience Platform is to create a dataflow. By now, you have the following required values prepared:
