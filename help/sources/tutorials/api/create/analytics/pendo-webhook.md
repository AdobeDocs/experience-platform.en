...
---
# (Beta) Create a source connection and dataflow for [!DNL Pendo] using the Flow Service API
...
## Connect [!DNL Pendo] to Platform using the [!DNL Flow Service] API
...
| `baseConnectionId` | The base connection ID of [!DNL Pendo]. This ID was generated in an earlier step. |
