...
## Connect [!DNL Pendo] to Experience Platform using the [!DNL Flow Service] API {#connect-platform-to-flow-api}
...
The last step towards bringing data from [!DNL Pendo] to Experience Platform is to create a dataflow. By now, you have the following required values prepared:
