...
If you would prefer to use the user interface in Experience Platform, the [Salesforce source connector UI tutorial](../../../ui/create/crm/salesforce.md) provides step-by-step instructions for performing similar actions.
