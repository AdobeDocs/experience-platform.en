...
Once you have retrieved your [!DNL Mailchimp] authentication credentials, you can now start the process of creating dataflow to bring [!DNL Mailchimp Members] data to Experience Platform. The first step in creating a dataflow is to create a base connection.
