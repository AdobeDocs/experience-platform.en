...
| `auth.params.maxConcurrentConnections` | The maximum concurrent connections to specify when connecting Platform to SFTP. When enabled, this value must be set to at least 1. |
