...
Read this guide to learn how you can connect your [!DNL Amazon] S3 source account to Adobe Experience Platform using the [[!DNL Flow Service] API](https://www.adobe.io/experience-platform-apis/references/flow-service/).
