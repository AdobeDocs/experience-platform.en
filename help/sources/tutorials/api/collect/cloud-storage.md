...
| `params.path` | The path of the source file you are accessing. This parameter can point to an individual file or an entire folder. |
| `params.type` | The file type of the source data file you are ingesting. Individual files are ingested as `file` and entire folders can be ingested as `folder`. |
