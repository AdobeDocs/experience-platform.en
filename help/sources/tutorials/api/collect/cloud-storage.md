...
| `params.type` | The file type of the source data file you are ingesting. Use type `file` to ingest and individual file and use  type `folder` to ingest an entire folder. |
