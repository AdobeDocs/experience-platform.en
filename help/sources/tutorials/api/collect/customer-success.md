...
This tutorial covers the steps for retrieving data from a Customer Success ("CS") system and ingesting it into Platform through source connectors and APIs.
