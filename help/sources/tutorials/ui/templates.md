...
>[!NOTE]
>
>Templates can auto-generate model-based schemas when working with sources that require change data capture workflows or support multiple data models.  
...
>For more information, see the [Model-based schemas overview](../../../xdm/schema/model-based.md).
