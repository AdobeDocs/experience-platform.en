...
Additionally, this tutorial requires that you have already created a protocols account. A list of tutorials for creating different protocol connectors in the UI can be found in the [source connectors overview](../../../home.md).

## Select data

After creating your protocols account, the *[!UICONTROL Select data]* step appears, providing an interactive interface for you to explore your file hierarchy.
...
The *[!UICONTROL Mapping]* step appears, providing an interactive interface to map the source data to a [!UICONTROL Platform] dataset.
...
he *[!UICONTROL Mapping]* screen also allows you to set *[!UICONTROL Delta column]*. When the dataflow is created, you can set any timestamp field as a basis to decide which records to ingest in scheduled incremental ingestions.
...
The *[!UICONTROL Dataflow detail]* step appears, where you must provide a name and an optional description for the dataflow. Click **[!UICONTROL Next]** when finished.
