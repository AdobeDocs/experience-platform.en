...
type: Tutorial
description: A dataflow is a scheduled task that retrieves and ingests data from a source to a Platform dataset. This tutorial provides steps on how to create a dataflow for a marketing automation source using Platform UI.
exl-id: 8d31fc2d-b952-44f7-98e7-f51b0acc19ed
---
# Create a dataflow using a marketing automation source in the UI

A dataflow is a scheduled task that retrieves and ingests data from a source to a dataset in Adobe Experience Platform. This tutorial provides steps on how to create a dataflow for a marketing automation source using the Platform UI.

>[!NOTE]
>
>* In order to create a dataflow, you must already have an authenticated account with a marketing automation source. A list of tutorials for creating different marketing automation source accounts in the UI can be found in the [sources overview](../../../home.md#marketing-automation).
...
After creating your marketing automation source account, the **[!UICONTROL Add data]** step appears, providing an interface for you to explore your marketing automation source account's table hierarchy.
...
By following this tutorial, you have successfully created a dataflow to bring data from your marketing automation source to Platform. Incoming data can now be used by downstream [!DNL Experience Platform] services such as [!DNL Real-Time Customer Profile] and [!DNL Data Science Workspace]. See the following documents for more details:
