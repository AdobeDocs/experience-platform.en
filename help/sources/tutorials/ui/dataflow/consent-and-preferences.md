...
type: Tutorial
description: A dataflow is a scheduled task that retrieves and ingests data from a source to an Experience Platform dataset. This tutorial provides steps on how to create a dataflow for a consent and preferences source using Experience Platform UI.
exl-id: 340b5945-baa1-4f79-88fa-2572606f6083
TQID: https://experienceleague.adobe.com/rIUl1NLY7e4TlQ4u-6GsdRbDg5qx4tSw5KQ9yiadJlc
product_v2:
...
>[!IMPORTANT]
>
>You cannot map any dynamic key-pair values as an object from [!DNL OneTrust] to Experience Platform and must specify those keys in the target schema in order to map your data during ingestion.
...
By following this tutorial, you have successfully created a dataflow to bring data from your consent and preferences source to Experience Platform. Incoming data can now be used by downstream [!DNL Experience Platform] services such as [!DNL Real-Time Customer Profile] and [!DNL Data Science Workspace]. See the following documents for more details:
