...
The member balance source lists balances of rewards your members have. `balances` and `balanceSummaries` are arrays. When using these in audiences, content personalization, conditions and other such locations, you will often have to either select out one particular entry or repeat something for all entries. In general, use `balances` if you need to separate different balances with expirations of the same reward, and `balanceSummaries` if you want one entry for each reward ignoring expirations.
...
| `balanceSummaries[]`               |                                      | Balances aggregated by reward ID.                                                                                                                                                                                                                                                                      |
| `balanceSummaries[].totalAmount`   | 500                                  | The amount of reward items in this balance. For stored value, this is in the lowest unit of denomination (cents).                                                                                                                                                                                      |
| `balanceSummaries[].rewardId`      | 123                                  | The ID for a [!DNL LAVA] reward. This never changes for a given reward.                                                                                                                                                                                                                                |
| `balanceSummaries[].rewardName`    | F&B Credit                           | The name for the reward configured in the [!DNL LAVA] Moment Activation Console. This can be changed.                                                                                                                                                                                                  |
| `balanceSummaries[].rewardSlug`    | Credit                               | The primary slug for the reward configured in the [!DNL LAVA] Moment Activation Console. This can be changed.                                                                                                                                                                                          |
| `balanceSummaries[].rewardType`    | stored                               | The type of reward (access, offer, points, stored or voucher)                                                                                                                                                                                                                                          |
...
| `balanceSummaries[]`               | `_tenant.balanceSummaries[]`     |
