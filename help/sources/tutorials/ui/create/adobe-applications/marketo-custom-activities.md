...
To add a target field, select the schema icon ![schema icon](/help/images/icons/schema.png) and then select the custom activity fields from the target schema.
