...
Next select [!UICONTROL Classifications] and then select the classifications datasets that you want to ingest to Experience Platform. You can also search for a specific classification.
