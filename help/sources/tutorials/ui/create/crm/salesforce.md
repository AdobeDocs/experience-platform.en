...
Once you have gathered your required credentials, you can follow the steps below to create a new [!DNL Salesforce] account to connect to [!DNL Platform].
...
Under the *[!UICONTROL Databases]* category, select **[!UICONTROL Salesforce]** followed by **[!UICONTROL Add data]** to create a new Salesforce connector.
...
By following this tutorial, you have established a connection to your [!DNL Salesforce] account. You can now continue on to the next tutorial and [configure a dataflow to bring data into Platform](../../dataflow/crm.md).