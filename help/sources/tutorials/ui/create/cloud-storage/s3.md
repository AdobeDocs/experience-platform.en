...
Under the *[!UICONTROL Databases]* category, select **[!UICONTROL Amazon S3]** click **Add data** to create a new S3 connector.
...
By following this tutorial, you have established a connection to your S3 account. You can now continue on to the next tutorial and [configure a dataflow to bring data from your cloud storage into Platform](../../dataflow/batch/cloud-storage.md).