...
If you already have an S3 connection, you may skip the remainder of this document and proceed to the tutorial on [configuring a dataflow](../../dataflow/batch/cloud-storage.md).
...
Once you have gathered your required credentials, you can follow the steps below to linky your S3 account to [!DNL Platform].
