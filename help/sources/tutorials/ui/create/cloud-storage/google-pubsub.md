...
| Credentials | The credential or private key ID required to authenticate [!DNL PubSub]. You must ensure that you put the complete JSON file after removing the white spaces from your credentials.|
