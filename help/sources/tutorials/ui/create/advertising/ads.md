...
| Login Customer ID | The login customer ID is the account number that corresponds with the Google Ads manager account through which you want to fetch report data of a specific customer. |
