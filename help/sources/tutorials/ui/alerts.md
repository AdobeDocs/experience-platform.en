...
| ~~Sources Dataflow Lack of Ingestion~~ | ~~This alert sends you a message if ingestion is delayed by more than seven hours and no data gets ingested to Platform.~~ <br>**Note:** This alert has been deprecated.|
