...
The following list outlines all data usage labels currently supported by [!DNL Experience Platform].

More information regarding [!DNL Data Governance] and DULE can be found in the [Data Governance overview](../home.md).
