...
| Result Limit | <ul><li>Query Service UI - 100 rows</li><li>Third-party clients - 50,000</li><li>[!DNL PostgresSQL] client - 50,000</li></ul> | <ul><li>Query Service UI (no upper limit to rows)</li><li>Third-party clients  (no upper limit to rows)</li><li>[!DNL PostgresSQL] client  (no upper limit to rows)</li><li>REST APIs (no upper limit to rows)</li></ul> |
