...
If compute hours are constrained due to idle sessions, administrators can free capacity using session management. See [Manage Query Service sessions](./session-management.md) for instructions.
