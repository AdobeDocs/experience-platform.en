...
>abstract="Please remember, it is your sole responsibility to adhere to your organizations data governance policies and meet your regulatory requirements. Experience Platform provides data governance tools for you to manage your data usage obligations. Apply the appropriate data usage labels before querying or processing data. See the documentation to learn about data governance tools and best practices"
