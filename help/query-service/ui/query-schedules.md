...
>[!IMPORTANT]
>
>Starting August 18, 2026, you cannot create a new query schedule that runs more than once per hour. Existing sub-hourly schedules continue to run as configured and are not changed by this release.
