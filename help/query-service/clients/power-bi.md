...
To connect [!DNL Power BI] to Query Service, open [!DNL Power BI] and select **[!DNL Get Data]** in the top menu ribbon.

![The [!DNL Power BI] dashboard Home tab with Get data highlighted.](../images/clients/power-bi/open-power-bi.png)

Enter "[!DNL PostgreSQL]" in the search bar to narrow the list of data sources. Under the results that appear, select **[!DNL PostgreSQL database]**, followed by **[!DNL Connect]**.
...
![The [!DNL PostgreSQL] database dialog with Data Connectivity mode highlighted.](../images/clients/power-bi/connectivity-mode.png)
...
The table is now imported into [!DNL Power BI]. 
...
From the [!DNL PostgreSQL] database popover, select **[!DNL Advanced options]** to enter a custom SQL query in the **[!DNL SQL statement]** section. This custom query should be used to flatten your JSON name-value pairs into a table format.
