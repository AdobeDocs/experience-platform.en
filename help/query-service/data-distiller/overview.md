...
To use Data Distiller to keep long-term behavioral history in the data lake while promoting only activation-ready signals into Profile, see [Long-term personalization with Data Distiller](./long-term-personalization.md). To compare that approach with Customer Journey Analytics and Federated Audience Composition, see [Choose the right long-term personalization approach](../../hygiene/choose-a-personalization-approach.md).
