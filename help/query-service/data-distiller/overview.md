...
To learn how Data Distiller derives activation-ready signals from historical data in the data lake, see [Long-term personalization with Data Distiller](./long-term-personalization.md). To compare that approach with Customer Journey Analytics and Federated Audience Composition, see [Choose the right long-term personalization approach](../../hygiene/choose-a-personalization-approach.md).
