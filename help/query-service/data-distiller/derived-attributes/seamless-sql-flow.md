...
The data types supported are: boolean, date, datetime, text, float, bigint, integer, map, array, struct

The SQl codeblock below provides examples to define row, map, and array datatypes. Line one demonstrates row syntax. Line two map syntax, and line three, array syntax.
