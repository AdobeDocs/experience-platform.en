...
---
# (Beta) Monitor batch query license usage {#monitor-license-usage}

>[!IMPORTANT]
>
>The ability to monitor batch query license usage through the UI is in beta. Its features and documentation are subject to change.
