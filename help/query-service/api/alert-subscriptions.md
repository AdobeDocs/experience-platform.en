...
<!-- Delay Alert: This alert notifies you if there is a delay in the outcome of a scheduled query execution beyond a specified threshold. You can set a custom time that trigger the alert when the query runs for that duration without either completing or failing.  -->
