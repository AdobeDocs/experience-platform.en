...
| Parameter                    | Description                                                                                                                     | Default value  | Possible Values                                |
|-------------------------------|--------------------------------------------------------------------------------------------------------------------------------|----------------|------------------------------------------------|
| `MAX_ITER`                    | The maximum number of iterations the algorithm will run.                                                                       | 20             | (>= 0)                                         |
...
| `AGGREGATION_DEPTH`   | The depth used for aggregation during computation.                                                                                                                       | 2              | (>= 1)                                   |
...
| `DOC_CONCENTRATION`           | Concentration parameter ("alpha") for the prior placed on documents' distributions over topics. Controls regularization (smoothing).                                    | Automatic      | Any single value or vector of length k   |
| `KEEP_LAST_CHECKPOINT`        | Indicates whether to keep the last checkpoint when using the `em` optimizer.                                                                                            | `true`           | `true`, `false`                          |
