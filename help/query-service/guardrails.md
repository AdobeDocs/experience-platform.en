...
* **Reporting API**: An API for making data fetch calls (internally or externally). These extended reporting data models that are derived from natively provided reporting data models in Adobe Experience Platform such as the Real-Time CDP dashboards data model.
