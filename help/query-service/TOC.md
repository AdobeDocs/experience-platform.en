...
user-guide-description: Query Service allows you to use standard SQL to query data in Platform, letting you join datasets in the Data Lake and capture the results as a new dataset for use in reporting, machine learning, or for ingestion into Real-time Customer Profile.
---
