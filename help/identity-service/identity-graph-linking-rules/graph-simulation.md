...
description: Learn how to use the Graph Simulator in the Identity Service UI.
badge: Beta
---
# Graph Simulation
...
Read this document to learn how you can use Graph Simulation too better understand identity graph behavior and how the graph algorithm functions.
