...
>
>* Your account must be provisioned with the **View Identity Graph** permission in order to access identity settings in the UI. For more information, read the [guide on permissions in attribute-based access control](../../access-control/abac/ui/permissions.md).
