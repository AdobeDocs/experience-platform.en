...
You can get started by following the [notebook to recipe](../jupyterlab/create-a-model.md) workflow to create the Product Recommendations recipe in a Jupyter Notebook, and implement the recipe in [!DNL Experience Platform] [!DNL Data Science Workspace].
