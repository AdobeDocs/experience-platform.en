...
Start by loading your training data. In the **RTML Authoring** template, the CSV dataset is grabbed from Github. If you wish to use a dataset from within Adobe Experience Platform, uncomment the cell below *Load Training Data*. You need to replace the `dataset_id` with the appropriate value. 
...
After uncommenting, copy and paste the `model_id` in the following cell. 
