...
| Monitoring support for [Custom Personalization](../../destinations/catalog/personalization/custom-personalization.md) destinations | You can now view dataflow runs information for [Custom Personalization](../../destinations/catalog/personalization/custom-personalization.md) destinations in the [monitoring dashboard](../../dataflows/ui/monitor-destinations.md). Use this data to verify that audiences are activating as expected. |
