...
![The audiences interface before the update.](./assets/july/audiences-before.png)

>[!TAB After]

![The audiences interface after the update.](./assets/july/audiences-after.png)
...
![The audience details interface before the update.](./assets/july/audience-details-before.png)

>[!TAB After]

![The audience details interface after the update.](./assets/july/audience-details-after.png)
...
![The datasets interface before the update.](./assets/july/datasets-before.png)

>[!TAB After]

![The datasets interface after the update.](./assets/july/datasets-after.png)
...
![The sources catalog before the update.](./assets/july/sources-before.png)

>[!TAB After]

![The sources catalog after the update.](./assets/july/sources-after.png)
