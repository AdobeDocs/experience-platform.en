...
| Feature | Description |
| --- | --- |
| [[!DNL Microsoft Ads Customer Match]](../../destinations/catalog/advertising/microsoft-ads-customer-match.md) destination is now generally available | Use the [!DNL Microsoft Ads Customer Match] destination to match customers by email address and reengage with them across the [!DNL Microsoft Advertising Network], including [!DNL Search] and [!DNL Audience] ads. **Note**: The [!DNL Microsoft Ads Customer Match] destination is rolling out to all customers over the course of this week, by July 30. |
