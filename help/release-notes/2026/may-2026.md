...
| Data insights for audiences | You can now view summary data for your people-based and account-based audiences. For more information on the summary data for people-based audiences, read the [Segment Builder overview](/help/segmentation/ui/audience-builder.md#attributes). For more information on the summary data for account-based audiences, read the [Audience Builder overview](/help/rtcdp/segmentation/audience-builder.md#attributes). |
