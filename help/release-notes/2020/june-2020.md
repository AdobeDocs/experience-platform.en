...
| Feature | Description |
| ------- | ----------- |
| Additional API and UI support for cloud storage systems | New source connectors for Apache HDFS |
| Additional API and UI support for databases | New source connectors for Couchbase. |
