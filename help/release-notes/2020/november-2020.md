...
| Feature | Description |
| ------- | ----------- |
| API support for deleting connections | Connections that were made with errors or have become unnecessary can be deleted using the [!DNL Flow Service] API. See the tutorial on [deleting connections](../../sources/tutorials/api/delete.md) for more information. |
