...
| Feature | Description |
| ------- | ----------- |
| API and UI support for cloud storages | New source connectors for Azure File Storage. |
| API and UI support for databases | New source connectors for Azure Data Explorer, IBM DB2, and Oracle DB. |
