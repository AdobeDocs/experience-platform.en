...
| New documentation | Description |
| ----------------- | ----------- | 
| [Audience Portal](../../segmentation/ui/audience-portal.md) | Learn how to use Audience Portal, which lets you to view, manage, and create audiences within Adobe Experience Platform in a centralized hub. |
