...
TQID: https://experienceleague.adobe.com/g0B--M7o4QlxN9WUemTkMm1HYbtmAQRjNwS9cPSX3F8
product_v2:
...
| Feature | Description |
| ------- | ----------- |
| Time constraints update | The behavior for the "This month" and "This year" has been updated, and they now represent the "month-to-date" and "year-to-date" respectively. For more information on this change, read the [Segment Builder guide](../../segmentation/ui/audience-builder.md#rule-builder-canvas). |
