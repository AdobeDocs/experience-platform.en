...
TQID: https://experienceleague.adobe.com/46Y4ksUAZdPrco4XeBKQu5hZ6JB4pavuVge0nVu0v2Y
product_v2:
...
| Segment Builder estimates | Estimates and qualified profiles are now displayed within the audience properties section. For more information on this change, read the [Segment Builder UI guide](../../segmentation/ui/audience-builder.md). |
