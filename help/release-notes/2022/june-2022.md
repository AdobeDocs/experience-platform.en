...
| [Mailchimp event forwarding extension](../../tags/extensions/client/mailchimp/overview.md) | The Mailchimp event forwarding extension sends events to the Mailchimp Marketing API that can trigger emails for Mailchimp marketing campaigns, journeys, or transactions. |
