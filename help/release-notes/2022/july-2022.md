...
TQID: https://experienceleague.adobe.com/N5f6vJic-wgwi4d21sak--8D-IgU5i-LRSOhOrBrkfQ
product_v2:
...
Adobe is no longer investing in supporting [Internet Explorer 10 (IE10)](https://docs.microsoft.com/en-us/lifecycle/announcements/internet-explorer-10-end-of-support) and [Internet Explorer 11 (IE11)](https://docs.microsoft.com/en-us/lifecycle/announcements/internet-explorer-11-end-of-support) for tags in Adobe Experience Platform. Microsoft has ended support for these browsers, modern web technologies are increasingly incompatible with them, and the broader industry has moved away from them. These factors make it difficult and costly to maintain backward compatibility. While Adobe is not actively removing IE10 and IE11 support, new tags features are no longer tested or optimized for these browsers. This change enables Adobe to provide faster delivery of modern capabilities.
