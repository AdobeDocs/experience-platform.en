...
| General availability of [!DNL Salesforce Marketing Cloud] source | Use the [!DNL Salesforce Marketing Cloud] source to bring marketing automation data from your [!DNL Salesforce Marketing Cloud] instance to Platform. See the [[!DNL Salesforce Marketing Cloud] overview](../../sources/connectors/marketing-automation/salesforce-marketing-cloud.md) for more information. |
