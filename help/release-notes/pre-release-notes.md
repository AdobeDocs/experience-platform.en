...
| [Audience-level reporting for additional destinations](../dataflows/ui/monitor-destinations.md#audience-level-view) | Audience-level dataflow reporting is now available for the following destinations: [!DNL Gainsight PX], [!DNL TikTok], [!DNL LinkedIn Matched Audience], [!DNL Demandbase People], (Legacy) [!DNL Amazon Ads], [!DNL Pinterest], [!DNL Twitter Tailored Audiences], [!DNL Braze], (Companies) [!DNL LinkedIn Matched Audience], [!DNL Facebook Custom Audience], [!DNL Mailchimp Tags], and [!DNL Salesforce CRM]. |
