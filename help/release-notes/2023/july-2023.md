...
- You can now export audiences to [JSON or Parquet files](/help/destinations/ui/activate-batch-profile-destinations.md#supported-file-formats-export), in addition to the CSV format which was already supported.
