...
| [Support for deduplication keys](../../destinations/ui/batch-destinations-mapping-reference.md#deduplication-keys) | Eliminate multiple records of the same profile in the export files by selecting a deduplication key. You can select a single namespace or up to two XDM schema attributes as a deduplication key. |
