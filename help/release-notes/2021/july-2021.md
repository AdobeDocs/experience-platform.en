...
| Feature | Description |
| ------- | ----------- |
| Scheduled queries | You can now, using the Query Editor, schedule queries in Platform. To learn more, please read the documentation on the [Query Editor](../../query-service/ui/user-guide.md#scheduled-queries). |
