...
| Secret | [!DNL LinkedIn] OAuth 2 Secret | The [[!DNL LinkedIn] OAuth 2 Secret](../../tags/ui/event-forwarding/secrets.md#linkedin-oauth-2) allows you to use Adobe and [!DNL LinkedIn] service tokens to support server-server interactions in event forwarding. |
