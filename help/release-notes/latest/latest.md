...
| New documentation | Description |
| ----------------- | ----------- | 
| [Audience Portal](../../segmentation/ui/audience-portal.md) | Learn how to use Audience Portal, which allows you to view, manage, and create audiences within Adobe Experience Platform in a centralized hub. |
...
Unified Tags lets you categorize and manage your business objects within Adobe Experience Platform. You can create both folders and tags which can be used to better organize Platform objects such as audiences or datasets by using endpoints in the Unified Tags API.
