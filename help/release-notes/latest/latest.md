...
B2B enterprises often have their customer information stored in multiple systems, each including only partial or even conflicting data for the same real-world business entity. This creates a massive challenge of arriving at an accurate view of their customers, therefore reducing the efficiency and effectiveness of their B2B marketing and sales efforts. With the release of lead to account matching, CDP B2B matches known person profiles to account profiles so that they can be segmented and targeted with B2B context data such as account, opportunity etc.

Read more about the feature in the following documentation pages:

- [Lead to account matching in CDP B2B](../../rtcdp/b2b-ai-ml-services/lead-to-account-matching.md)
- [Lead to account matching profile enrichment in the monitor profile enrichment guide](../../dataflows/ui/b2b/monitor-profile-enrichment.md)
- [How to use related accounts in segment definitions](../../rtcdp/segmentation/b2b.md#related-accounts)

To learn more about Real-time CDP B2B Edition, see the [Real-Time CDP overview](../../rtcdp/overview.md).
