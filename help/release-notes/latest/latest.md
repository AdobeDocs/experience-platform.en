...
<!-- 
Adobe has corrected incorrect entries in your product's associated TermSheets to match their corresponding [Product Descriptions](https://helpx.adobe.com/legal/product-descriptions.html). The discrepancies in your term sheets will be corrected on **June 9, 2023** to provide an accurate representation of your license usage and ensure contractual compliance for your organization. Note that it can take up to 24-36 hours for the licence usage reports to reflect the update.

Adobe has also corrected several **Average Profile Richness base quantities** to be in-line with their corresponding Product Descriptions. The discrepancies in your term sheets will also be corrected on **June 9, 2023**.
