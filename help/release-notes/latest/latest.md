...
Unified Tags lets you categorize and manage your business objects within Adobe Experience Platform. With the Unified Tags API, you can create both folders and tags to better organize Platform objects such as audiences or datasets.
