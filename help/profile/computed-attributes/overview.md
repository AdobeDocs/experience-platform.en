...
| LIST | A function that **lists** the last specified number of attributes that match the given rule. | N/A | List the names of the last 50 orders in the past week. |
