...
>[!IMPORTANT]
>
>ExperienceEvent lookup using the Profile access API will be deprecated. Please use features such as computed attributes for use cases that require looking up ExperienceEvents.
