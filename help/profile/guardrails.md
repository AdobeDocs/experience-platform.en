...
| Guardrail | Limit | Limit Type | Description|
| --- | --- | --- | --- |
| Segments per sandbox | 4000 | Soft | An organization can have more than 10,000 segments in total, as long as there are less than 10,000 segments in each individual sandbox. Attempting to create additional segments may affect system performance.|
...
| Batch segments per sandbox | 4000 | Soft | An organization can have more than 10,000 batch segments in total, as long as there are less than 10,000 batch segments in each individual sandbox. Attempting to create additional batch segments may affect system performance.|
