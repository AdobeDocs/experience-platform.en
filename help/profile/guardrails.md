...
| Edge segments per sandbox | 250 | Soft | An organization can have more than 250 edge segments in total, as long as there are less than 250 edge segments in each individual sandbox. Attempting to create additional edge segments may affect system performance. | 
