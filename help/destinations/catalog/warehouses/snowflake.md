...
Use the [!DNL Snowflake] Streaming destination to share audience data from [!DNL Adobe CX Enterprise] applications with your [!DNL Snowflake] account. If you arrived from [!DNL Real-Time CDP Collaboration], see [Activate audiences from Real-Time CDP Collaboration](#activate-collaboration) for the details specific to that application.
