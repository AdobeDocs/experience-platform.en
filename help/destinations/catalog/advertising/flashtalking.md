...
The [!DNL Flashtalking OneTag] tag extension makes it easy to attribute site actions to display, video, and mobile ad activity. Deploy the [!DNL Flashtalking OneTag] to your web properties using Launch.
