...
[!DNL Amazon Ads v2] enables advertisers to efficiently ingest, manage, activate, and reuse audience data across Amazon Ads products.
...
* **[!UICONTROL Ads data manager Terms & Conditions]**: Accept the Amazon Ads Data Manager terms and conditions. See the [accept terms](#accept-terms) section for details.
...
Combine first-party identifiers (such as phone, address, etc.) with partner-provided identifiers. This allows [!DNL Amazon Ads] to use multiple identity signals during audience matching, leading to better match rates.
