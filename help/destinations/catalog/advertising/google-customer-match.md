...
|`first_name`|First name of the user| This target identity is meant to be used along with `last_name`, `country_code`, and `postal_code`, when you want to send mailing address data to your destination. <br><br>If you omit any of these four identities from your mapping, none of the other three will be sent to your destination.|
|`last_name`|Last name of the user|This target identity is meant to be used along with `first_name`, `country_code`, and `postal_code`, when you want to send mailing address data to your destination. <br><br>If you omit any of these four identities from your mapping, none of the other three will be sent to your destination.|
|`country_code`|User address country code|This target identity is meant to be used along with `first_name`, `last_name`, and `postal_code`, when you want to send mailing address data to your destination. <br><br>If you omit any of these four identities from your mapping, none of the other three will be sent to your destination. <br><br>Accepted format: Lowercase, 2-letter country codes in [ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) format.|
|`postal_code`|User address postal code|This target identity is meant to be used along with `first_name`, `last_name`, and `country_code`, when you want to send mailing address data to your destination. <br><br>If you omit any of these four identities from your mapping, none of the other three will be sent to your destination.|
