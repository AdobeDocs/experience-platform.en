...
>[!IMPORTANT]
>
>- To activate data, you need the **View Destinations**, **Activate Destinations**, **View Profiles**, and **View Segments** ![access control permissions](/help/access-control/home.md#permissions). Read the ![access control overview](/help/access-control/ui/overview.md) or contact your product administrator to obtain the required permissions.
