...
>
>With the release of EUID (European Unified ID), you are now seeing two [!DNL The Trade Desk - CRM] destinations in the Destinations catalog.
>* If you source data in the EU, please use [!DNL The Trade Desk - CRM (EU)] destination. 
>* If you source data in the APAC or NAMER regions, please use [!DNL The Trade Desk - CRM (NAMER & APAC)] destination. 
>
