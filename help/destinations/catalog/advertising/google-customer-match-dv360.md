...
Certain Google-integrated third parties, such as Adobe [!DNL Real-Time CDP], can use the [!DNL Google Audience Partner API] to create [!DNL Customer Match] audiences directly in customers' [!DNL Display & Video 360] account.
...
## Important notice about changes to Google destinations related to updated consent requirements in the European Union {#eu-consent-notice}
...
><br/>
>Customers who have not purchased Adobe Privacy & Security Shield must use the [segment definition](../../../segmentation/home.md#segment-definitions) capabilities within [Audience Builder](../../../segmentation/ui/audience-builder.md) to filter out non-consented profiles, to continue using the existing [!DNL Real-Time CDP] Google Destinations without interruption.

## When to use this destination {#when-to-use}
...
To help you better understand how and when to use this destination, here are sample use cases that [!DNL Adobe Experience Platform] customers can solve by using this feature.
...
>[!NOTE]
>
>For this destination, you will see one dataflow run per day, regardless of how many audiences are activated or how many identity namespaces are mapped in the dataflow.
