...
* **[!UICONTROL Port]**: The port used for your [!DNL LiveRamp - Onboarding] storage location.  This is contingent on your geographic region.
  * US: Use Port "22"
  * APAC: Use Port "2222"     
...
*  **[!UICONTROL Region]**: Geographic region for your instance of the LiveRamp sftp.
...
Exported files have a maximum size of 10 million rows, thus Adobe will generate multiple files per delivery if selected Segments exceed the 10MM row count.  Please let your LiveRamp representative know if you'll exceed a single file so that they can configure LiveRamp's ingestion automation to process the files in a batch fashion.
...
|---|---|---|
|March 2024|Functionality and documentation update|<ul><li>Added support for deliveries to Europe and Australia LiveRamp sftp instances</li><li>Updated documentation to describe specific configurations for newly supported regions</li><li>Increased maximum file size to 10 million rows (previously 5 million)</li><li>Updated documentation to reflect increased file sizes</li></ul>|
