...
>[!NOTE]
>
> The functionality described in this section is available for all cloud storage destinations. However, the [Amazon S3](amazon-s3.md) destination currently supports the `%SEGMENT_ID%` and `%SEGMENT_NAME%` macros only.
