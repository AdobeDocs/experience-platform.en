...
TQID: https://experienceleague.adobe.com/s2gnXja70bbHY3k-dK303NYXzB48drW89gldgzkT7MA
product_v2:
...
To send audience data to [!DNL Oracle Eloqua], you must first [connect the destination](#connect-destination) in [!DNL Adobe Experience Platform], and then [set up a data import](#import-data-into-eloqua) from your storage location into [!DNL Oracle Eloqua].
