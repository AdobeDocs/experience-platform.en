...
TQID: https://experienceleague.adobe.com/KP4bjzhUwm7VtozpmuvJSUP2asQHFHCV5iMjVzkEe1U
product_v2:
...
The [!DNL Quantum Metric] tag extension facilitates codeless deployment of [!DNL Quantum Metric's] data collection capabilities. In addition, this extension offers the ability to capture data elements containing useful information from the [!DNL Quantum Metric] API.

[!DNL Quantum Metric] is an analytics extension in [!DNL Adobe Experience Platform]. For more information about the extension functionality, see the extension page on [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101535.quantum-metric-extension-for-adobe-launch.html).
