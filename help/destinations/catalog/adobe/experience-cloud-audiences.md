...
* Composite segments are not directly supported. You will need to create an AEP segment based on your composite segment in order to activate via this destination. 
