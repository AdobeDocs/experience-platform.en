...
The video below also demonstrates the steps to configure a social destination and activate segments. The video uses LinkedIn as an example, but the steps are similar across social destinations.
