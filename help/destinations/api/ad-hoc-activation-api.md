...
Follow the instructions described [here](../../segmentation/api/export-jobs.md#retrieve-list) to retrieve a list of all the audience export jobs.
...
>[!NOTE]
>
>For non–segmentation service audiences (for example, external or custom upload audiences), you must specify the audience ID generated by Experience Platform in your request, not the external audience ID. You can find the system-generated ID in the audience summary view in the audiences UI.
...
| Property | Description |
| -------- | ----------- |
| `segment` | The ID of the activated audience. |
| `order` | The ID of the destination to which the audience was activated. |
