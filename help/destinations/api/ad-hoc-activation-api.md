...
>[!NOTE]
>
>For non–segmentation service audiences (for example, [external or custom upload audiences](../../segmentation/ui/audience-portal.md#import-audience)), you must specify the audience ID generated by Experience Platform in your request, not the external audience ID. You can find the system-generated ID in the [audience summary view](../../segmentation/ui/audience-portal.md#audience-summary) in the audiences UI.
