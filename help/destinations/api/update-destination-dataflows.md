...
>
>The `profileSelectors` method described in this section works for most streaming destinations. However, some streaming destinations, including **[!DNL Adobe Target]**, require the Data Prep mapping set workflow instead. 
>
