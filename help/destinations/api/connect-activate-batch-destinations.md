...
*   [[!DNL Segmentation Service]](../../segmentation/api/overview.md): [!DNL Adobe Experience Platform Segmentation Service] lets you build audiences in [!DNL Adobe Experience Platform] from your [!DNL Real-Time Customer Profile] data.
