...
Use [!UICONTROL Destinations] to activate your data from [!DNL Adobe Experience Platform] to countless external partners.
...
To learn more about monitoring dataflows for destinations, read the [Monitor dataflows for destinations in the UI](../../dataflows/ui/monitor-destinations.md) tutorial.
