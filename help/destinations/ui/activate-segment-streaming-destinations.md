...
title: Activate audience data to streaming audience export destinations
type: Tutorial
...
You can activate multiple types of audiences, depending on their origin. See []() for details about what each type of audience origin means.
