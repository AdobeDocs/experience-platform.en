...
* UI guides {#ui}
    ...
    * Activate audience data to destinations{#activate}
        ...
        * [Activate audience data to edge personalization destinations](./ui/activate-edge-personalization-destinations.md)
...
* Destinations catalog {#catalog}
    ...
    * Advertising destinations{#advertising}
        ...
        * [(Alpha) LiveRamp - SFTP connection](./catalog/advertising/liveramp.md)
