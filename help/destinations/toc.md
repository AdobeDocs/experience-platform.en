...
* Destinations catalog {#catalog}
    ...
    * Advertising destinations{#advertising}
        ...
        * [Google Ads](./catalog/advertising/google-ads-destination.md)
    ...
    * Analytics destinations {#analytics}
        ...
        * [Google Global Site Tag analytics extension](./catalog/analytics/gtag-analytics.md)
    ...
    * Email destinations {#email}
        * [Bizible Analytics extension](./catalog/email/bizible.md)
    ...
    * Survey destinations {#survey}
        ...
        * [Foresee extension](./catalog/survey/foresee.md)
        * [InMoment extension](./catalog/survey/inmoment.md)
        * [Qualtrics Website Feedback extension](./catalog/survey/qualtrics.md)
        * [Web Intercept Surveys - QuestionPro extension](./catalog/survey/web-intercept-surveys.md)
...
* Destinations API tutorials {#api}
