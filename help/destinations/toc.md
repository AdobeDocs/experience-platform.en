...
* Destinations catalog {#catalog}
    ...
    * Cloud storage destinations {#cloud-storage}
        ...
        * [IP address allow list for cloud storage destinations](./catalog/cloud-storage/ip-address-allow-list.md)
    ...
    * Streaming destinations {#streaming}
        ...
        * [IP address allow list for streaming destinations](./catalog/streaming/ip-address-allow-list.md)
