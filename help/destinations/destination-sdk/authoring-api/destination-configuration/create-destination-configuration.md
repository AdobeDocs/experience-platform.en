...
|`description` | String | Provide a description that Adobe will use in the Experience Platform destinations catalog for your destination card. Aim for no more than 4-5 sentences. ![Experience Platform UI image showing the destination description.](../../assets/authoring-api/destination-configuration/destination-description.png "Destination description"){width="100" zoomable="yes"}|
