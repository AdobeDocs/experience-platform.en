---
description: Learn how to use Destination SDK to configure a file-based destination to export account audiences to a storage location.
title: Configure a file-based destination to export account audiences to a storage location
---
# Configure a file-based destination to export account audiences to a storage location

## Overview {#overview}

This page describes how to use Destination SDK to configure a file-based destination with custom [file formatting options](configure-file-formatting-options.md) and a custom [file name configuration](../../functionality/destination-configuration/batch-configuration.md#file-name-configuration) to export [account audiences](../../../ui/activate-account-audiences.md). The examples in this guide describe how to export audiences of prospect profiles to an Amazon S3 location.

You can also set up STFP or other storage locations to export account audiences. The important part to remember is to add the snippet below to the destination configuration in [step 2](#create-destination-configuration) to enable the [workflow to export account audiences](/help/destinations/ui/activate-prospect-audiences.md) to the destination.
...
curl -X POST https://platform.adobe.io/data/core/activation/authoring/destinations \
 ...
 -d '
{
   "name":"Amazon S3 destination to export account audiences",
   "description":"Amazon S3 destination to export account audiences",
   "status":"TEST",
   "sources": [
    "ACCOUNTS"
   ],
...
By reading this article, you now know how to use Destination SDK to author a custom [!DNL Amazon S3] destination to export account audiences.
