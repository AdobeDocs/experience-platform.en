...
|Destination type | People audiences | Account audiences | Prospect audiences | Dataset audiences|
|---------|----------|---------|---------|---------|
| Streaming | ✓ | ✓ | X | X |
| File-based | ✓ | ✓ | ✓ | ✓ |
...
## Export multiple audience data types (file-based destinations only) {#multiple}

File-based destinations support the export of multiple audience data types. You can include one or multiple audience data types in the `sources` array, as shown below.
...
"sources":[
   ...
   // Specifies that this destination supports people, account, prospect, and dataset audiences
] 
```
...
>[!TAB File-based destination]

+++ File-based destination configuration example with people audiences support
...
```json
"sources":[
   "ACCOUNTS" // Specifies that this destination supports people and account audiences
] 
```
...
+++ Streaming destination configuration example with people and account audiences support
...
+++ File-based destination configuration example with people and account audiences support
...
```json
"sources":[
   "UNIFIED_PROFILE_PROSPECTS" // Specifies that this destination supports people and prospect audiences
] 
```
...
+++ File-based destination configuration example with people and prospect audiences support
...
+++ Streaming destination configuration example with people and dataset audiences support
 ...
 -d '
{
   ...
   "status":"TEST",
   "sources":[
      "DATASETS" // Specifies that this destination supports people and dataset audiences
   ], 
   "customerAuthenticationConfigurations":[
      {
         "authType":"BEARER"
...
+++ File-based destination configuration example with people and dataset audiences support
