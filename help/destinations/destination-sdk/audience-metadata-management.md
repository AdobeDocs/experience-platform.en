...
The functionality described in this document can be configured using the `/authoring/audience-templates` API endpoint. Read [Audience metadata endpoint API operations](./audience-metadata-api.md) for a complete list of operations you can perform on the endpoint.
