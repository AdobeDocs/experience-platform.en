...
>[!TIP]
>
>Before you start crafting and editing your message transformation template, you might want to start calling the render template API endpoint with a simple template that exports your raw profiles without applying any transformations. The syntax for the simple template is: <br> `"template": "{% for profile in input.profiles %}{{profile|raw}}{% endfor %}}"`
